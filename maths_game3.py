...
class Button:
    ...
    def draw(self, surface):
        ...
        # Draw the button text centred inside the button
...
class HomeScreen:
    def __init__(self):
        self.start_button = Button(300, 350, 200, 55, "START", (109, 138, 116), (50, 100, 50))
    ...
    def draw(self, surface):
        ...
        # Logo
        logo_rect = logo.get_rect(center=(screen_width // 2, 180))
...
class TopicScreen:
    def __init__(self):
        ...
        # Build topic buttons in a 2 column grid
        self.topic_buttons = []
        button_width = 210
        button_height = 50
        start_x = 185
        ...
        for i in range(len(self.topics)):
            ...
            btn = Button(x,y,button_width,button_height,topic,(119, 158, 112),(42, 94, 28))
        ...
        # Confirm button proceeds to next screen
