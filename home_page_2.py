...
class HomeScreen:
    ...
    def draw(self, surface):
        ...
        # Game title
        title_surface = font_large.render("SPACE INVADERS", True, (255, 255, 255))
...
class DifficultyScreen:
    ...
    def draw(self,surface):
        ...
        # Heading 
        heading = font_large.render("Select Difficulty", True, (50,100,50))  
        ...
        if self.selected_difficulty:
            label = font_small.render("Selected:" + self.selected_difficulty, True, (50,100,50))
        else:
    ...
    def handle_event(self,event):
        ...
        # Back button returns to topic senection 
        if self.back_button.is_clicked(event):
            self.selected_difficulty = None
            return "topic"
